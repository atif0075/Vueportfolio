<template>
  <main class="py-9 flex items-center z-10 relative">
    <a href="https://github.com/atif0075" target="_blank">
      <button
        class="px-5 py-2 text-sm md:text-base bg-dark hover:bg-mud text-white duration-300 ease-in-out mr-5 font-DMSan font-bold rounded-md border-dashed border border-mud"
      >
        <svg
          viewBox="0 0 14 14"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          class="w-5 h-5 inline-block mx-1"
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
    ...
    <button
      class="px-5 py-2 text-sm md:text-base bg-green text-dark focus:ring-offset-light-green duration-300 ease-in-out hover:bg-light-green font-DMSan font-bold rounded-md"
    >
